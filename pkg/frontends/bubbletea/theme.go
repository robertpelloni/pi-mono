...
var (
	...
	// Autocomplete styles
	StyleCompletionItem     = lipgloss.NewStyle().Foreground(lipgloss.Color("250"))
	StyleCompletionSelected = lipgloss.NewStyle().Foreground(ColorAssistant).Bold(true).Background(lipgloss.Color("236"))
	StyleCompletionHeader   = lipgloss.NewStyle().Foreground(ColorHeader).Bold(true).Underline(true)
)
